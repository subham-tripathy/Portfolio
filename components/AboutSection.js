...
const TAB_DATA = [
    ...
    },
    {
        ...
        content: (
            <ul className='list-disc pl-2'>
                <Link href='https://bit.ly/DownloadGoogleCloudComputingCertificate'><li>Google Cloud Computing - NPTEL Course</li></Link>
            </ul>
        )
    }
]
    ...
    <section className='text-white' id='about'>
        <div className='md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16'>
            ...
            <div className='mt-4 md:mt-0 text-left flex flex-col h-full'>
                ...
                I specialize as a Full Stack Web Developer, driven by a keen interest in crafting dynamic and adaptable web applications. Proficient in HTML, CSS, JavaScript, PHP, React.js, Next.js, Node.js, SQL, and Git, my expertise encompasses a broad technology stack. A rapid learner, I consistently seek opportunities to broaden my knowledge and enhance my skill repertoire. Emphasizing collaboration, I thrive as a team player and eagerly anticipate the chance to contribute to the development of outstanding applications alongside others.
            </p>
