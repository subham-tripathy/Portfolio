    ...
    <div id='home'>
      <div className='grid grid-cols-1 sm:grid-cols-12'>
        <div className='col-span-7 place-self-center text-center sm:text-left'>
          ...
          <div>
            <a download href='/Subham Tripathy Resume.pdf' className='my-10 px-6 py-3 rounded-full bg-white hover:bg-gray-200 font-bold bg-gradient-to-tr from-blue-600 to-green-600'>Download CV</a>
          </div>
        </div>
